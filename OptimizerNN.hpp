#ifndef OPTIMIZER_NN_HPP
#define OPTIMIZER_NN_HPP
...
public:
	...
	void BackPropagation(ManagedArray& input)
	{
		...
		// cost = sum(-Y_true * log(Y) - (1 - Y_true) * log(1 - Y))
		Cost = 0.0;
		L2 = 0.0;
	...
	ManagedArray SetupLabels(ManagedArray& output, NeuralNetworkOptions opts)
	{
	...
	void SetupNetwork(ManagedArray& output, NeuralNetworkOptions opts)
	{
		...
		Y_true = SetupLabels(output, opts);
	...
	void Run(ManagedArray& input, ManagedArray& output, NeuralNetworkOptions opts)
	{
